...
# Loading tokenizers
tokenizer_BERT = BertTokenizer.from_pretrained("C:/Users/sm20pd/OneDrive/Desktop/4P84 trial/Bert_tweet")
tokenizer_DistilBERT = DistilBertTokenizer.from_pretrained("C:/Users/sm20pd/OneDrive/Desktop/4P84 trial/DistilBERT_tweet")
tokenizer_ALBERT = AlbertTokenizer.from_pretrained("C:/Users/sm20pd/OneDrive/Desktop/4P84 trial/Albert_tweet")
...
model_BERT_untrained = BertForSequenceClassification.from_pretrained('bert-base-uncased',num_labels=num_lables)
model_DistilBERT_untrained = DistilBertForSequenceClassification.from_pretrained('distilbert-base-uncased',num_labels=num_lables)
model_ALBERT_untrained = AlbertForSequenceClassification.from_pretrained('albert-base-v2',num_labels=num_lables)

# Defining the fine-tuned models
model_BERT_finetuned = BertForSequenceClassification.from_pretrained('C:/Users/sm20pd/OneDrive/Desktop/4P84 trial/Bert_tweet',num_labels=num_lables)
model_DistilBERT_finetuned = DistilBertForSequenceClassification.from_pretrained('C:/Users/sm20pd/OneDrive/Desktop/4P84 trial/DistilBERT_tweet',num_labels=num_lables)
model_ALBERT_finetuned = AlbertForSequenceClassification.from_pretrained('C:/Users/sm20pd/OneDrive/Desktop/4P84 trial/Albert_tweet',num_labels=num_lables)
...
# Create DataFrames for DistilBERT model performance
...
df_all_models.to_csv('C:/Users/sm20pd/OneDrive/Desktop/4P84 trial/DataFrame/results.csv')
